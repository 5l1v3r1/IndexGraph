...
namespace gt {
  namespace stinger {
    ...
    */
	...
	void set_stinger(stinger_t * S);

	stinger_t * get_stinger();

	// @ADD: set and get func
	void set_shared(SharedBuffer * s);
	SharedBuffer * get_shared();

	void set_varray(VertexArray * va);
	VertexArray * get_varray();
