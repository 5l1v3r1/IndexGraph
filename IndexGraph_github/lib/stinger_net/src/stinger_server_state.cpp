 ...
 * PRIVATE METHODS
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
StingerServerState::StingerServerState() : port_streams(10104), port_algs(10106),
...
// @ADD: set and get
void StingerServerState::set_shared(SharedBuffer * s) {
  shared = s;
}

// @DONE: set and get vertex array instance
void StingerServerState::set_varray(VertexArray * v) {
  va = v;
}

VertexArray * StingerServerState::get_varray() {
  return va;
}

SharedBuffer * StingerServerState::get_shared() {
  return shared;
}
